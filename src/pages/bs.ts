...
import { getOrMountRepo, type RepoIndex, type Repository } from "../cloudstate/simple-repo";
    ...
    JSON.stringify(
      await repoIndex
        ...
        .then(async(repo) => {
         ...
         const files=  fs.readFileSync(`/ca9821ce-32d8-478f-822d-9bee7cb02351/.git/objects/60/e5a64c402b13e887d1616932a49150046d81a3`, {
          });
